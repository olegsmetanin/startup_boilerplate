...
assembleproto='echo "Assemble proto" && cat ./proto/pre.prototpl ./proto/echo.prototpl ./proto/user.prototpl > ./proto/public.proto && cat ./proto/pre.prototpl ./proto/echo.prototpl ./proto/user.prototpl > ./proto/private.proto' 
